...
String sql="select id,name,email,mobile_no,gender,birthdate,address,city,pincode,State,scheme_name,password,status from scheme,schemereg where scheme.scheme_id=schemereg.scheme and status='Rejected'";
